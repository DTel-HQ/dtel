...
exports.run = (bot, message, args) => {
  ...
  else if (bot.users.get(args[1]).bot) {
      message.reply("**ARE YOU SURE THAT BOTS ARE HUMAN?** <:Monocle:366036726449438731>");
      return;
  }
  else if (bot.users.get(args[1]).id === message.author.id && !bot.guilds.get('281815661317980160').members.get(message.author.id).roles.find("name","Boss")) {

    ...
    embed: {
      ...
      fields: [
        ...
        },
        {
          ...
          value: "Most numbers have a prefix of `03XX`, where `XX` represents your shard number. There are some numbers with a prefix of `0900`, which are DM numbers (numbers you can assign in a direct message with the bot), and they act the same as `03XX` numbers, which can *also* have the same digits as `03XX` numbers. Numbers starting with `0800` or `0844`, as well as short codes starting with `*` or `#` are for special uses."
        },
        {
          name: "💰 Recharging",
          value: "You can either earn credits in the bot, transfer credits from other bots, or donate to DiscordTel's development in exchange of credits. See [this page](http://discordtel.readthedocs.io/en/latest/Payment/) for details.\nAfter recharging, dial `*233` or `>balance` to check balance."
        },
        {
          name: "🔖 Phonebook",

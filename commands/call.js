...
module.exports = async(client, message, args) => {
	...
	if (!mynumber) {
		...
		await client.apiSend(`:telephone: A call is established between channel ${message.channel.id} and channel ${toDialDocument._id} by __${message.author.tag}__ (${message.author.id}).`, process.env.LOGSCHANNEL);

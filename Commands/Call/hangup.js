module.exports = async(client, msg, suffix) => {
	...
	client.log(`:negative_squared_cross_mark: ${call.rcall ? "Rcall" : "call"} \`${call.from.channel} → ${call.to.channel}\` was hung up by ${msg.author.tag} (${msg.author.id}) on the ${msg.channel.id === call.from.channel ? "from" : "to"} side.`);

const embed = {
    ...
    description:  `To celebrate the festive season, we're holding a special Christmas giveaway! \n\nTo enter, all you have to do is **react to this message with the :christmas_tree: emoji**. You will receive <:DTS:668551813317787659>**1000** and have a 5% chance at winning **2 months of VIP**!\n\n_In other news..._\n\nThis has been a strange year, but we've been working on the bot and overall we've done pretty well. We hope we've helped you connect to others during this tough time.\n\nMeanwhile, we've been hard at work planning out V4. We hope to start working on the actual bot very soon! And a reminder: we're still looking for devs, artists and more! [**Join the support server to apply!**](${config.guildInvite})\n\nMerry Christmas, and let's have a great new year :)\n- The DTel Team`, 

module.exports = async(client, msg, suffix) => {
	...
	if (!toBlock.match(/^0[39]0\d{8}$/)) return msg.channel.send({ embed: { color: config.colors.error, title: "Invalid number", description: "Invalid or special number. You can't block special numbers. Please report any abuse by calling `*611`" } });

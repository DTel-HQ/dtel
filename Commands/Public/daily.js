module.exports = async(client, msg, suffix) => {
	...
	await msg.channel.send({ embed: { color: config.colors.success, title: "Claimed your dailies!", description: `Here's your ${amount} credits! You now have ${client.format(account.balance)}.\n\nYou can vote for DiscordTel on various bot listings to get **60+ more credits every day**! See ${config.voteLink} for a list of voting sites.` } });

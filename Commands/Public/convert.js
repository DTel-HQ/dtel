...
module.exports = async(client, msg, suffix) => {
	...
	try {
		...
		if (!error) {
			...
			client.log(`<:Discoin:357656754642747403> ${msg.author.username} converted <:DTS:668551813317787659>${client.format(amount)} into ${client.format(newTransaction.payout)} ${emoji} using Discoin.`);
		}
	}
};

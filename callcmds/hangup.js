...
exports.run = (bot, message, fs, calls, call) => {
	...
	bot.channels.get("282253502779228160").send(`:negative_squared_cross_mark: The call between channel ${call.from.channel} and channel ${call.to.channel} was hung up by __${message.author.tag}__ (${message.author.id}) on the "from" side.`);

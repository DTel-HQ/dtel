	...
	switch (collected.content) {
		...
		case "2": {
			let cEmbed = new MessageEmbed()
				...
				.setDescription(`Promoting this number will cost ${config.dtsEmoji}${config.promoteCost}. (non-refundable)\nDTel staff have the right to delete this promotion at any time.`)

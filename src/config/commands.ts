...
const commands: Command[] = [
	...
	{
		name: "assign",
		description: `Assign a number to a channel. [Support Only]`,
		guildOnly: false,
		numberRequired: false,
		options: [{
			name: "number",
			description: "The number you want to assign",
			required: true,
			type: ApplicationCommandOptionType.String,
			minLength: 11,
			maxLength: 11,
			...
			name: "channel",
			description: "The channel to which you are assigning the number",
			required: true,
			type: ApplicationCommandOptionType.String,
			minLength: 11,
			maxLength: 11,
	...
	},
	{
		...
		options: [{
			name: "number",
			description: "The number you want to delete",
			required: true,
			type: ApplicationCommandOptionType.String,
			minLength: 11,
		}],

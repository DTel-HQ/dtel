...
module.exports = async(client, msg, suffix) => {
	...
	if (!number) return msg.channel.send({ embed: embeds.invalidNumber });
	...
	client.log(`:green_book: Number \`${numberDoc.id}\` has been assigned to channel ${numberDoc.channel} by \`${msg.author.tag}\` (${msg.author.id}).`);
};
